...
from ingest_fix_size import load_documents, chunk_document
...
def chat(message, history):
    ...
    generated_result =  generate_response(message, retrieved)
    print("============question", message)
    print("============result",generated_result)
    ...
    gr.HTML("""
        <div style="text-align:center; padding:1.25rem 0 0.5rem;">
            ...
            <p style="color:#6b7280; font-size:1rem; margin:0.4rem 0 0;">
                Ask anything about your professor — answers straight from the professor reviews.
            </p>
        </div>
    """)
    ...
    with gr.Row():
        with gr.Column(scale=3):
            gr.ChatInterface(
                ...
                examples=[
                    "Who teaches CS3650?",
                    "How is Professor Alvaro Monge rated?",
                    "Which courses has Jonathan Bell taught?",
                   "Who are the three highest rated CS professors at Northeastern?",
                   "What is the average rating across Kaan Onarlioglu's review comments?",
                ],
...
if __name__ == "__main__":
    print("\n" + "="*50)
    print("  ProfessorAssistant — starting up")
    print("="*50 + "\n")
    run_ingestion()
